...
export default function WishlistSearchLauncher({ hasDiscogsToken }: Props) {
  ...
  function goToReleaseSearch() {
    ...
    const params = new URLSearchParams({ for: 'wishlist' })
    if (q) params.set('q', q)
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">
            Add Record to Your Wishlist
          </h1>
          <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
            You can search Discogs for a particular release/pressing or search for an existing release within your collection from which to add a wishlist item.
            <br />
            <br />
            Each search will produce a list of matches from which you can select a particular title to pre-populate a Wishlist Item form.
          </p>
        </div>
